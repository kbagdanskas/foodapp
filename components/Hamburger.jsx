...
export const Links = () => (<>
    ...
    <Link href="/about"><a className='font-bold p-4'>Gerimai</a></Link>
    <Link href="/pizzas"><a className='font-bold p-4'>Pica</a></Link>
    <Link href="/more"><a className='font-bold p-4'>Priedai</a></Link>
    <Link href="/contact"><a className='font-bold p-4'>Kontaktai</a></Link>
</>)
